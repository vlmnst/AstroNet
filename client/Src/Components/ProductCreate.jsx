...
import { Text, View, TextInput, Button, StyleSheet, Alert, useWindowDimensions} from "react-native";
...
const styles = StyleSheet.create({
    ...
    input: { backgroundColor: '#FFFFFF', marginTop: 0, marginHorizontal: 10, padding: 5, width: useWindowDimensions },
    inputmul: { backgroundColor: '#FFFFFF', marginTop: 10, marginHorizontal: 10, padding: 5, height: 100, width: useWindowDimensions },
